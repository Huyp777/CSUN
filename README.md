...
============================================================================
We propose an end-to-end **C**oarse-to-fine cross-moda**L** s**E**mantic **A**lignment netwo**R**k, dubbed **CLEAR**, to efﬁciently localization target moments within the given video via diverse natural language queries. <br>
